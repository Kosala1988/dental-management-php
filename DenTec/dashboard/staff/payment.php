<?php
// payment.php - Enhanced with receipt printing functionality
session_start();
...
// Handle payment recording - ENHANCED VERSION
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'record_payment') {
    ...
    if (!empty($missing_fields)) {
        ...
        if ($record_id <= 0) {
            ...
            $error_message = "Invalid payment date format";
        } else {
                            ...
                            if ($record_info['status'] !== 'Completed') {
                                ...
                                if (!$insert_stmt) {
                                    ...
                                    if ($insert_stmt->execute()) {
                                        ...
                                        $success_message = "Payment of $" . number_format($amount, 2) . " recorded successfully!";
                                        
                                        // Log successful payment
                                        error_log("Payment recorded successfully: ID $payment_id, Record $record_id, Amount $amount");
...
$stats = $payment_stats_result ? $payment_stats_result->fetch_assoc() : [
    'total_payments' => 0, 'total_amount' => 0, 'today_total' => 0, 'week_total' => 0, 'month_total' => 0
];
...
<body>
            ...
            <?php if (isset($success_message) && !empty($success_message)): ?>
                <div class="alert alert-success alert-dismissible fade show success-animation" role="alert">
                    ...
                    <?php if (isset($payment_id) && $payment_id): ?>
                        <div class="mt-2">
                            <button class="btn btn-sm btn-outline-success me-2" onclick="printReceipt(<?php echo $payment_id; ?>)">
                                <i class="bi bi-printer me-1"></i>Print Receipt
                            </button>
                            <button class="btn btn-sm btn-outline-info" onclick="viewReceipt(<?php echo $payment_id; ?>)">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card card-stat card-success">
                        <div class="card-body position-relative">
                            ...
                            <h2> <?php echo number_format($stats['today_total'], 2); ?></h2>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card card-stat card-info">
                        <div class="card-body position-relative">
                            ...
                            <h2> <?php echo number_format($stats['week_total'], 2); ?></h2>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card card-stat card-primary">
                        <div class="card-body position-relative">
                            ...
                            <h2> <?php echo number_format($stats['month_total'], 2); ?></h2>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                <button class="btn btn-outline-info" onclick="viewReceipt(<?php echo $row['payment_id']; ?>)" title="View Receipt">
                                                    <i class="bi bi-eye"></i>
                                                </button>
                                                <button class="btn btn-outline-success" onclick="printReceipt(<?php echo $row['payment_id']; ?>)" title="Print Receipt">
                ...
                <form method="POST" id="paymentForm" novalidate>
                    <div class="modal-body">
                        ...
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="checkbox" id="auto_print_receipt" checked>
                            <label class="form-check-label" for="auto_print_receipt">
                                <i class="bi bi-printer me-1"></i>Automatically print receipt after payment
                            </label>
                        </div>
                    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            receiptModal = new bootstrap.Modal(document.getElementById('receiptPreviewModal'));
        ...
        function openPaymentModal(recordId, patientId, patientName, balance) {
            ...
            document.getElementById('auto_print_receipt').checked = true;
        ...
        function printReceipt(paymentId) {
            ...
            const printWindow = window.open('print_receipt.php?print=1&id=' + paymentId + '&auto_print=1', 
                                          '_blank', 
        ...
        function viewReceipt(paymentId) {
            ...
            fetch('get_receipt_preview.php?id=' + paymentId)
                .then(response => {
                    if (!response.ok) {
                ...
                .then(data => {
                    document.getElementById('receiptPreviewContent').innerHTML = data;
                })
                .catch(error => {
        ...
        // Auto-print receipt after successful payment if checkbox is checked
        <?php if (isset($payment_id) && $payment_id): ?>
        document.addEventListener('DOMContentLoaded', function() {
            // Small delay to ensure the success message is visible
            setTimeout(function() {
                if (confirm('Payment recorded successfully! Would you like to print the receipt now?')) {
                    printReceipt(<?php echo $payment_id; ?>);
                }
            }, 1000);
        });
        <?php endif; ?>
        ...
        console.log('Enhanced payment management system with receipt printing loaded successfully');
    </script>
</body>
</html>